...
const styles = StyleSheet.create({
  ...
  sub: { fontFamily: 'Inter_400Regular', fontSize: fontSize.sm, color: colors.textMuted, marginBottom: spacing.lg, lineHeight: 22 },
  quickFoods: { gap: spacing.sm, marginBottom: spacing.lg },
  foodRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.bgSecondary, borderRadius: radius.lg, padding: spacing.md, gap: spacing.md, borderWidth: 1, borderColor: colors.border },
  foodEmoji: { fontSize: 28 },
  foodInfo: { flex: 1 },
  foodName: { fontFamily: 'Inter_600SemiBold', fontSize: fontSize.md, color: colors.text },
  foodCal: { fontFamily: 'Inter_400Regular', fontSize: fontSize.sm, color: colors.textMuted },
  addBtn: { width: 32, height: 32, borderRadius: 16, backgroundColor: colors.bgDark, alignItems: 'center', justifyContent: 'center' },
  addBtnText: { color: '#fff', fontSize: 20, fontWeight: '300', marginTop: -1 },
  skipButton: { alignItems: 'center', padding: spacing.md },
  skipText: { fontFamily: 'Inter_400Regular', fontSize: fontSize.sm, color: colors.textMuted },
})